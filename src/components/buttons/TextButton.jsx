...
export default function TextButton({
  ...
  return (
    <button
      type={type}
      disabled={disabled}
      className={`text-sm font-medium inline-flex items-center focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transition-all ${variantClass} ${className}`}
      {...props}
    >
      {children}
    </button>
