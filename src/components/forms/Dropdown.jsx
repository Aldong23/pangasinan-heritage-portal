...
export const Content = ({
  align = "right",
  width = "48",
  contentClasses = "py-1 bg-cyan-800 text-cyan-100 dark:bg-cyan-700 dark:text-cyan-50",
  children,
}) => {
  ...
  return (
    <Link
      ...
      className={`block w-full px-4 py-2 text-start text-sm leading-5 transition duration-150 ease-in-out 
                  text-cyan-100 dark:text-cyan-50 
                  hover:bg-cyan-700 dark:hover:bg-cyan-600 
                  focus:bg-cyan-700 dark:focus:bg-cyan-600 
